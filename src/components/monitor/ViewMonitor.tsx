...
export default function ViewMonitor({monitorInfo}: any) {
  ...
  return (
   <>
<div className="chart-wrapper mx-auto my-5 flex max-w-6xl flex-col flex-wrap items-center justify-start gap-2 p-6 sm:flex-row sm:p-8">
  ...
  <div className="flex flex-col text-center sm:text-left">
    ...
    <div className="chart-wrapper mx-auto my-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      ...
      <Card
        ...
        >
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid auto-rows-min gap-2">
              <div className="flex items-baseline gap-1 text-2xl font-bold tabular-nums leading-none">
              {new Date(monitorInfo.sslInfo.valid_to).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
                <span className="text-sm font-normal text-muted-foreground">
                SSL valid until
                </span>
              </div>
              ...
              >
                <BarChart
                  ...
                  data={[
                    {
                      date: new Date(monitorInfo.sslInfo.valid_to).toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' }),
                      steps: 100,
                    },
                  ]}
                >
