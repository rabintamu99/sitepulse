...
const MonitoringCard = ({ siteName, status, uptime, responseTime }: MonitoringCardProps) => {
    return (
      <div className={`flex flex-col justify-center border ${status === 200 ? 'border-gray-700' : 'border-red-400'} mb-2 rounded-lg shadow-sm w-full md:min-w-[600px] lg:min-w-[800px] xl:max-w-[1100px] relative`}>
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-row items-center px-2  mb-4 md:mb-0">
