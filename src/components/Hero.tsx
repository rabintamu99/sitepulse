...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen gap-2 pb-10">
      ...
      <FlipWords words={['Detect', 'Avoid', 'Fix']} duration={1000} className='text-9xl font-bold '/>
      <span className="text-9xl font-bold">Downtime</span>
      <p className="mt-4 text-xl">Monitor your website's uptime and performance with ease.</p>
      <div className="flex items-center gap-4 justify-center mt-6 relative z-10" style={{ opacity: 1, transform: 'none' }}>
        <button 
          className="bg-neutral-900 relative z-10 hover:bg-black/90 border border-transparent text-sm text-white md:text-sm transition font-medium duration-200 rounded-full px-4 py-2 flex items-center justify-center shadow-[0px_-1px_0px_0px_#FFFFFF40_inset,_0px_1px_0px_0px_#FFFFFF40_inset]"
